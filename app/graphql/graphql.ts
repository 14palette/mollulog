...
export type QueryRaidArgs = {
  raidId: InputMaybe<Scalars['String']['input']>;
  uid: InputMaybe<Scalars['String']['input']>;
};
...
export type UserPickupEventsQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', uid: string, name: string, type: EventTypeEnum, since: Date, pickups: Array<{ __typename?: 'Pickup', student: { __typename?: 'Student', studentId: string } | null }> }> } };
...
export type IndexQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', name: string, since: Date, until: Date, uid: string, type: EventTypeEnum, rerun: boolean, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, student: { __typename?: 'Student', studentId: string, name: string, attackType: Attack, defenseType: Defense, role: RoleEnum, schaleDbId: string } | null }> }> }, raids: { __typename?: 'RaidConnection', nodes: Array<{ __typename?: 'Raid', name: string, since: Date, until: Date, uid: string, type: RaidTypeEnum, boss: string, attackType: Attack, defenseType: Defense, terrain: TerrainEnum }> } };
...
export type PickupEventsQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', uid: string, name: string, since: Date, until: Date, type: EventTypeEnum, rerun: boolean, pickups: Array<{ __typename?: 'Pickup', studentName: string, student: { __typename?: 'Student', studentId: string } | null }> }> } };
...
export type EventDetailQuery = { __typename?: 'Query', event: { __typename?: 'Event', uid: string, name: string, type: EventTypeEnum, since: Date, until: Date, imageUrl: string | null, videos: Array<{ __typename?: 'Video', title: string, youtube: string, start: number | null }>, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', studentId: string, attackType: Attack, defenseType: Defense, role: RoleEnum } | null }> } | null };
...
export type FutureContentsQuery = { __typename?: 'Query', contents: { __typename?: 'ContentInterfaceConnection', nodes: Array<{ __typename?: 'Event', rerun: boolean, name: string, since: Date, until: Date, confirmed: boolean, uid: string, eventType: EventTypeEnum, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', studentId: string, attackType: Attack, defenseType: Defense, role: RoleEnum, schaleDbId: string } | null }> } | { __typename?: 'Raid', rankVisible: boolean, boss: string, terrain: TerrainEnum, attackType: Attack, defenseType: Defense, name: string, since: Date, until: Date, confirmed: boolean, uid: string, raidType: RaidTypeEnum }> } };
...
export type StudentDetailQuery = { __typename?: 'Query', student: { __typename?: 'Student', name: string, studentId: string, attackType: Attack, defenseType: Defense, role: RoleEnum, school: string, schaleDbId: string, raidStatistics: Array<{ __typename?: 'RaidStatistics', difficulty: Difficulty, defenseType: Defense, slotsCount: number, assistsCount: number, raid: { __typename?: 'Raid', uid: string, name: string, boss: string, type: RaidTypeEnum, since: Date, until: Date, terrain: TerrainEnum }, slotsByTier: Array<{ __typename?: 'TierAndCount', tier: number, count: number }>, assistsByTier: Array<{ __typename?: 'TierAndCount', tier: number, count: number }> }> } };
