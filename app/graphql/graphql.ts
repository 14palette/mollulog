...
export type RaidRanksArgs = {
  filter: InputMaybe<Array<RaidRankFilter>>;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type EventDetailQuery = { __typename?: 'Query', event: { __typename?: 'Event', eventId: string, name: string, type: EventTypeEnum, since: Date, until: Date, imageUrl: string | null, videos: Array<{ __typename?: 'Video', title: string, youtube: string, start: number | null }>, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', studentId: string, attackType: Attack, defenseType: Defense, role: RoleEnum, schaleDbId: string } | null }> } | null };
...
export type RaidRanksQueryVariables = Exact<{
  raidId: Scalars['String']['input'];
  filter: InputMaybe<Array<RaidRankFilter> | RaidRankFilter>;
}>;
...
export type RaidDetailQuery = { __typename?: 'Query', raid: { __typename?: 'Raid', raidId: string, type: RaidTypeEnum, name: string, boss: string, since: Date, until: Date, terrain: TerrainEnum, attackType: Attack, defenseType: Defense } | null };
