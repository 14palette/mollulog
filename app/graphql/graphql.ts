...
export type IndexQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', name: string, since: Date, until: Date, uid: string, type: EventTypeEnum, rerun: boolean, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, since: Date, until: Date, student: { __typename?: 'Student', uid: string, name: string, attackType: Attack, defenseType: Defense, role: RoleEnum, schaleDbId: string | null } | null }> }> }, raids: { __typename?: 'RaidConnection', nodes: Array<{ __typename?: 'Raid', name: string, since: Date, until: Date, uid: string, type: RaidTypeEnum, boss: string, attackType: Attack, defenseType: Defense, terrain: TerrainEnum }> } };
...
export type EventDetailQuery = { __typename?: 'Query', event: { __typename?: 'Event', uid: string, name: string, type: EventTypeEnum, since: Date, until: Date, imageUrl: string | null, videos: Array<{ __typename?: 'Video', title: string, youtube: string, start: number | null }>, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, since: Date, until: Date, studentName: string, student: { __typename?: 'Student', uid: string, attackType: Attack, defenseType: Defense, role: RoleEnum } | null }> } | null };
...
export type FutureContentsQuery = { __typename?: 'Query', contents: { __typename?: 'ContentInterfaceConnection', nodes: Array<{ __typename?: 'Event', rerun: boolean, uid: string, name: string, since: Date, until: Date, confirmed: boolean, eventType: EventTypeEnum, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, since: Date, until: Date, studentName: string, student: { __typename?: 'Student', uid: string, attackType: Attack, defenseType: Defense, role: RoleEnum, schaleDbId: string | null } | null }> } | { __typename?: 'Raid', rankVisible: boolean, boss: string, terrain: TerrainEnum, attackType: Attack, defenseType: Defense, uid: string, name: string, since: Date, until: Date, confirmed: boolean, raidType: RaidTypeEnum }> } };
...
export type RaidRanksQuery = { __typename?: 'Query', raid: { __typename?: 'Raid', rankVisible: boolean, ranks: Array<{ __typename?: 'RaidRank', rank: number, score: number, parties: Array<{ __typename?: 'RaidRankParty', partyIndex: number, slots: Array<{ __typename?: 'RaidRankPartySlot', slotIndex: number, tier: number | null, level: number | null, isAssist: boolean | null, student: { __typename?: 'Student', uid: string, name: string } | null }> }> }> } | null };
...
export type StudentDetailQuery = { __typename?: 'Query', student: { __typename?: 'Student', name: string, uid: string, attackType: Attack, defenseType: Defense, role: RoleEnum, school: string, schaleDbId: string | null, pickups: Array<{ __typename?: 'Pickup', since: Date, until: Date, event: { __typename?: 'Event', type: EventTypeEnum, uid: string, name: string, rerun: boolean, imageUrl: string | null } }>, raidStatistics: Array<{ __typename?: 'RaidStatistics', difficulty: Difficulty, defenseType: Defense, slotsCount: number, assistsCount: number, raid: { __typename?: 'Raid', uid: string, name: string, boss: string, type: RaidTypeEnum, since: Date, until: Date, terrain: TerrainEnum }, slotsByTier: Array<{ __typename?: 'TierAndCount', tier: number, count: number }>, assistsByTier: Array<{ __typename?: 'TierAndCount', tier: number, count: number }> }> } };
