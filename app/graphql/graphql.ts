...
export type SitemapQuery = { __typename?: 'Query', contents: { __typename?: 'ContentInterfaceConnection', nodes: Array<{ __typename: 'Event', uid: string, until: Date } | { __typename: 'Raid', uid: string, until: Date }> } };
...
export type EventDetailQuery = { __typename?: 'Query', event: { __typename?: 'Event', uid: string, name: string, type: EventTypeEnum, since: Date, until: Date, imageUrl: string | null, videos: Array<{ __typename?: 'Video', title: string, youtube: string, start: number | null }>, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', uid: string, attackType: Attack, defenseType: Defense, role: RoleEnum } | null }> } | null };
...
export type FutureContentsQuery = { __typename?: 'Query', contents: { __typename?: 'ContentInterfaceConnection', nodes: Array<{ __typename?: 'Event', rerun: boolean, name: string, since: Date, until: Date, confirmed: boolean, uid: string, eventType: EventTypeEnum, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', uid: string, attackType: Attack, defenseType: Defense, role: RoleEnum, schaleDbId: string } | null }> } | { __typename?: 'Raid', rankVisible: boolean, boss: string, terrain: TerrainEnum, attackType: Attack, defenseType: Defense, name: string, since: Date, until: Date, confirmed: boolean, uid: string, raidType: RaidTypeEnum }> } };
...
export type RaidRanksQuery = { __typename?: 'Query', raid: { __typename?: 'Raid', rankVisible: boolean, ranks: Array<{ __typename?: 'RaidRank', rank: number, score: number, parties: Array<{ __typename?: 'RaidRankParty', partyIndex: number, slots: Array<{ __typename?: 'RaidRankPartySlot', slotIndex: number, tier: number | null, student: { __typename?: 'Student', uid: string, name: string } | null }> }> }> } | null };
...
export type StudentDetailQuery = { __typename?: 'Query', student: { __typename?: 'Student', name: string, uid: string, attackType: Attack, defenseType: Defense, role: RoleEnum, school: string, schaleDbId: string, raidStatistics: Array<{ __typename?: 'RaidStatistics', difficulty: Difficulty, defenseType: Defense, slotsCount: number, assistsCount: number, raid: { __typename?: 'Raid', uid: string, name: string, boss: string, type: RaidTypeEnum, since: Date, until: Date, terrain: TerrainEnum }, slotsByTier: Array<{ __typename?: 'TierAndCount', tier: number, count: number }>, assistsByTier: Array<{ __typename?: 'TierAndCount', tier: number, count: number }> }> } };
