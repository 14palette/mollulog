...
export default function BottomSheet({ children, Icon, title, onClose }: BottomSheetProps) {
  return (
    <>
      ...
      <div className="w-screen xl:max-w-3xl h-dvh max-h-80 md:max-h-96 fixed bottom-0 left-0 right-0 mx-auto p-4 md:p-8 bg-white dark:bg-neutral-800 z-200 rounded-t-2xl flex flex-col">
