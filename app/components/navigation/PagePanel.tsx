...
export default function PagePanel({ Icon, title, description, foldable, children }: PagePanelProps) {
  const [folded, setFolded] = useState(foldable ?? false);

  return (
    <div className="my-2 rounded-xl py-3 px-4 border border-neutral-200 dark:border-neutral-700">
      <div
        className="px-2 py-1 -mx-2 -my-1 flex items-center gap-3 hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded-lg cursor-pointer transition-colors"
