import { SetStateAction, Dispatch, useMemo, useState, useCallback, memo } from "react";
...
export const ShopResourceSelector = memo(function ShopResourceSelector({
  ...
  return (
    <>
      <SectionHeader title="상점 아이템" description="구매할 아이템의 개수를 선택하세요" folded={folded} setFolded={setFolded} />
